...
![image-20200501192629304](image/image-20200501192629304.png)
...
下面是在postman中的测试数据：
![image-20200501194449944](image/image-20200501194449944.png)
...
<img src="image/image-20200501195619925.png" alt="image-20200501195619925" style="zoom: 52%;" />

再次使用POST插入数据，仍然是新增的：

<img src="image/image-20200501195732492.png" alt="image-20200501195732492" style="zoom: 80%;" />



添加数据的时候，指定ID，会使用该id，并且类型是新增：

<img src="image/image-20200501200048361.png" alt="image-20200501200048361" style="zoom: 66%;" />

再次使用POST插入数据，类型为updated

<img src="image/image-20200501200132199.png" alt="image-20200501200132199" style="zoom:67%;" />
...
<img src="image/image-20200501212224983.png" alt="image-20200501212224983" style="zoom: 61%;" />

 （2）将name更新为2，更新过程中使用seq_no=6

http://192.168.137.14:9200/customer/external/1?if_seq_no=6&if_primary_term=1 

<img src="image/image-20200501213047499.png" alt="image-20200501213047499" style="zoom: 60%;" />
...
![image-20200501212924094](image/image-20200501212924094.png)
...
<img src="image/image-20200501213130001.png" alt="image-20200501213130001" style="zoom:75%;" />

#### 4）更新文档

![image-20200501214522818](image/image-20200501214522818.png)

 ![image-20200501215746139](image/image-20200501215746139.png)

（1）POST更新文档，带有_update

http://192.168.137.14:9200/customer/external/1/_update 

![image-20200501214810741](image/image-20200501214810741.png)

如果再次执行更新，则不执行任何操作，序列号也不发生变化

![image-20200501214912607](image/image-20200501214912607.png)

POST更新方式，会对比原来的数据，和原来的相同，则不执行任何操作（version和_seq_no）都不变。

 （2）POST更新文档，不带_update

![image-20200501215358666](image/image-20200501215358666.png)
...
<img src="image/image-20200501220559094.png" alt="image-20200501220559094" style="zoom:67%;" />
...
![image-20200501221105476](image/image-20200501221105476.png)
...
![image-20200501233938697](image/image-20200501233938697.png)

![image-20200502000221422](image/image-20200502000221422.png)

![image-20200502000733594](image/image-20200502000733594.png)
...
![image-20200502120921830](image/image-20200502120921830.png)
...
![image-20200511074437763](image/image-20200511074437763.png)
...
![image-20200511111618183](image/image-20200511111618183.png)

测试后：

![image-20200511112025327](image/image-20200511112025327.png)
