...
![1567922826266](image/1567922826266.png)

![1584799832037](image/1584799832037.png)

 ![1567924368985](image/1567924368985.png)
...
![1567925466441](image/1567925466441.png)

可以看到每条记录就是一个sku，再来看看每条记录需要哪些字段：

 ![1567925782145](image/1567925782145.png)

直观能看到：sku的默认图片、sku的价格、标题、skuId

![1567926242184](image/1567926242184.png)

排序及筛选字段：综合、新品、销量、价格、库存（是否有货）等

![1567926434794](image/1567926434794.png)
...
参考gmall-sms-interface，创建gmall-pms-interface及gmall-wms-interface
 ...
 ![1584806325178](image/1584806325178.png)

 ![1584806364604](image/1584806364604.png)



把gmall-wms和gmall-pms这两个工程中对应的entity都copy过来，方便通用。原先工程对应的entity就不用了，例如gmall-pms：

 ![1567950435754](image/1567950435754.png)
...
在gmall-search中添加feign接口：
 ...
 ![1584807796338](image/1584807796338.png)
...
编写GoodsRepository：
 ...
 ![1577432548337](image/1577432548337.png)
...
![1568017699170](image/1568017699170.png)

参照京东，设计模型如下：

 ![1589180479443](image/1589180479443.png)
...
## 2.3.   搜索的业务逻辑
 ...
 ![1577432765142](image/1577432765142.png)
...
![1584880572262](image/1584880572262.png)

copy到gmall-search工程的vo包下：

 ![1584880536717](image/1584880536717.png)
...
![1568041357992](image/1568041357992.png)

打印出的结果：放到`jsonviewer`工具查看，发现数据结构跟kibana几乎一模一样。直接参考kibana即可完成对数据的封装。

![1568047477761](image/1568047477761.png)
